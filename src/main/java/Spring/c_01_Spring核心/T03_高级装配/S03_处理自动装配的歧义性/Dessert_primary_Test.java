...
import Spring.c_01_Spring核心.T03_高级装配.S03_处理自动装配的歧义性.primary.DessertConfig;
...
public class Dessert_primary_Test {
   ...
   *
   * 但当存在多个@Primary后，同样会出现 多个bean同时匹配的问题， 你可以把 {@link Spring.c_01_Spring核心.T03_高级装配.S03_处理自动装配的歧义性.primary.Cookie} 的 @Primary 注解放开试试
